...
const footerLinks = {
  ...
  Resources: [
    ...
    { label: "Request Component", href: "/request" },
  ],
  Company: [
    { label: "About", href: "/about" },
    { label: "Terms", href: "/terms" },
    { label: "Privacy", href: "/privacy" },
    { label: "Contact", href: "mailto:contact.manager5603@gmail.com" },
  ],
}
    ...
    <footer className="border-t border-border bg-card/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12">
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed max-w-xs">
              Premium animated UI components for modern React applications. Built with Tailwind CSS and Framer Motion.
            </p>
            <div className="flex items-center gap-3 mt-6">
              ...
              <a
                href="mailto:contact.manager5603@gmail.com"
                className="w-9 h-9 rounded-md border border-border flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-accent transition-colors"
                aria-label="Email"
              >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
          <p>© {new Date().getFullYear()} UIverse. All rights reserved.</p>
